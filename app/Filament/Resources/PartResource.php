...
class PartResource extends Resource
{
            ...
            ->schema([
                ...
                Section::make('Informacje o części')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('sku')->label('SKU / kod wewnętrzny')->unique(ignoreRecord: true)->maxLength(255)->live(onBlur: true)->afterStateUpdated(fn (Forms\Get $get, Forms\Set $set, ?Part $record): null => self::refreshCategorySuggestion($get, $set, $record))->columnSpanFull(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('id')->label('ID')->sortable()->searchable()->weight('semibold')->color('gray')->copyable()->extraHeaderAttributes(['class' => 'gps-col-id'])->extraCellAttributes(['class' => 'gps-col-id'])->extraAttributes(['class' => 'gps-col-id-content']),
            ...
            Tables\Columns\ViewColumn::make('admin_part_channels')->label('Kanały / ceny / status wystawienia')->view('filament.resources.parts.table-channels')->viewData(fn (Part $record): array => ['part' => $record])->extraHeaderAttributes(['class' => 'gps-col-channels'])->extraCellAttributes(['class' => 'gps-col-channels'])->extraAttributes(['class' => 'gps-col-channels-content']),
