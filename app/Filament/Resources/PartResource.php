    ...
    public static function table(Table $table): Table
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query): Builder => $query->with([
                ...
                'marketplaceListings:id,part_id,marketplace,external_offer_id,external_listing_id,price,currency,status,sync_status,match_status,last_error,url,raw_payload,last_api_status,last_seen_at,not_seen_in_active_api_at',
