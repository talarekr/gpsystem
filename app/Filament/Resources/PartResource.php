...
class PartResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('status')->label('Status')->formatStateUsing(fn (?string $state) => Part::statusOptions()[$state] ?? $state)->badge()->color(fn (?string $state): string => Part::statusColor($state))->size('xs')->sortable()->extraHeaderAttributes(['class' => 'gps-col-status'])->extraCellAttributes(['class' => 'gps-col-status'])->extraAttributes(['class' => 'gps-col-status-content']),
