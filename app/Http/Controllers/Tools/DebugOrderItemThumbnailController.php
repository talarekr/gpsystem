    ...
    private function itemPayload(Order $order, OrderItem $item): array
    {
        ...
        return [
            ...
            'image_resolution' => [
                ...
                'resolved_part_id' => $debug['resolved_part_id'],
                'admin_parts_mechanism_part_id' => $debug['admin_parts_mechanism_part_id'],
                'admin_parts_mechanism_url' => $debug['admin_parts_mechanism_url'],
                'final_thumbnail_url' => $debug['final_thumbnail_url'],
                'admin_parts_mechanism_url_matches_final_thumbnail_url' => $debug['admin_parts_mechanism_url_matches_final_thumbnail_url'],
