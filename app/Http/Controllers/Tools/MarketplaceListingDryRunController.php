...
class MarketplaceListingDryRunController extends Controller
{
    ...
    private function allegroProductSetPreview(array $allegro, string $channel, string $productName): array
    {
        $productSet = ['product' => ['name' => trim($productName), 'parameters' => $allegro['product_parameters'] ?? []]];
