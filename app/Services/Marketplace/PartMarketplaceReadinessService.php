...
class PartMarketplaceReadinessService
{
    ...
    public function check(Part $part): array
    {
        return [
            ...
            'ebay' => $this->forMarketplace($part, 'eBay', 'ebay_de', ['ebay_de', 'ebay']),
        ];
    }

    /** @param array<int, string> $mappingChannels @return array<string, mixed> */
    private function forMarketplace(Part $part, string $label, string $channel, array $mappingChannels): array
    {
        try {
