...
<div class="wrap" x-data="mapper()" x-init="init()">
    <div class="top">
        <div class="title">
            ...
            <p>Obsługa wybiera kategorie z drzew. Identyfikatory techniczne zapisują się automatycznie w lokalnych mapowaniach.</p><label style="display:inline-flex;gap:8px;align-items:center;margin-top:10px;font-weight:700"><input type="checkbox" x-model="showHidden" @change="reloadLocal()"> Pokaż ukryte lokalne kategorie</label>
        </div>
        <div class="summary">
