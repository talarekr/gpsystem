...
<div class="gps-parts-list">
    ...
    @forelse ($gearboxes as $gearbox)
        ...
        <div class="gps-part-card"><div class="gps-admin-parts-grid">
            ...
            <div class="gps-part-col"><div class="gps-part-actions"><a class="gps-part-action" href="{{ JarekGearboxResource::getUrl('edit', ['record' => $gearbox]) }}" wire:navigate>Edytuj</a><a class="gps-part-action" href="{{ $ebayPreviewUrl }}" target="_blank" rel="noopener">eBay preview</a></div></div>
        </div></div>
    @empty
