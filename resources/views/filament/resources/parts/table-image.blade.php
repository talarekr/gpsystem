...
@once
    <style>
        ...
        .fi-ta-table [data-column="admin_part_title"] { width: 410px; min-width: 380px; }
        ...
        @media (max-width: 1100px) { .gps-admin-part-thumb { width: 118px; height: 92px; } .fi-ta-table [data-column="admin_part_title"] { min-width: 280px; } }
    </style>
@endonce
