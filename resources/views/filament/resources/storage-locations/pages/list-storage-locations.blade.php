    ...
    <div class="space-y-3">
        ...
        @forelse ($locations as $location)
            <div class="gps-card gps-grid" wire:key="storage-location-{{ $location->id }}">
                ...
                <div class="gps-cell"><span class="gps-badge {{ $location->is_active ? 'gps-ok' : 'gps-no' }}">{{ $location->is_active ? 'Aktywne' : 'Nieaktywne' }}</span></div>
