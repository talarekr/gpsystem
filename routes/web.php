...
Route::middleware([Authenticate::class])->group(function (): void {
    ...
    Route::post('/admin/tools/ebay/listing-status-sync/start-persistent-scan', [EbayListingStatusBatchRunnerController::class, 'startPersistentScan'])->name('admin.tools.ebay.listing-status-sync.start-persistent-scan');
    Route::get('/admin/tools/ebay/listing-status-sync/persistent-scan/status', [EbayListingStatusBatchRunnerController::class, 'persistentScanStatus'])->name('admin.tools.ebay.listing-status-sync.persistent-scan.status');
    Route::post('/admin/tools/ebay/listing-status-sync/persistent-scan/run-next-batch', [EbayListingStatusBatchRunnerController::class, 'persistentScanRunNextBatch'])->name('admin.tools.ebay.listing-status-sync.persistent-scan.run-next-batch');
    Route::post('/admin/tools/ebay/listing-status-sync/persistent-scan/stop', [EbayListingStatusBatchRunnerController::class, 'persistentScanStop'])->name('admin.tools.ebay.listing-status-sync.persistent-scan.stop');
    Route::get('/admin/tools/ebay/listing-status-sync/persistent-scan/diagnose', [EbayListingStatusBatchRunnerController::class, 'persistentScanDiagnose'])->name('admin.tools.ebay.listing-status-sync.persistent-scan.diagnose');
    Route::get('/admin/tools/ebay/listing-status-sync/persistent-scan/ended-results', [EbayListingStatusBatchRunnerController::class, 'persistentScanEndedResults'])->name('admin.tools.ebay.listing-status-sync.persistent-scan.ended-results');
