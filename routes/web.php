...
use App\Http\Controllers\Tools\OvokoImportCarPayloadPreviewController;
...
use App\Http\Controllers\Tools\EbayListingStatusBatchRunnerController;
use App\Http\Controllers\Tools\EbayEndedListingLocalCleanupRunnerController;
...
use App\Http\Controllers\Tools\OvokoPartMappingResetController;
use App\Http\Controllers\Tools\OvokoPartMappingResetRunnerController;
...
Route::middleware([Authenticate::class])->group(function (): void {
    ...
    Route::get('/admin/tools/jarek-gearboxes/ebay-price-fetch-runner', [JarekGearboxEbayBulkPriceController::class, 'fetchRunner'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-price-fetch-runner');
    Route::get('/admin/tools/jarek-gearboxes/ebay-bulk-price-increase-runner', [JarekGearboxEbayBulkPriceController::class, 'applyRunner'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-bulk-price-increase-runner');
    Route::get('/admin/tools/jarek-gearboxes/ebay-bulk-price-increase-apply-runner', [JarekGearboxEbayBulkPriceController::class, 'applyRunner'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-bulk-price-increase-apply-runner');
    Route::post('/admin/tools/jarek-gearboxes/ebay-bulk-price-increase-apply-runner', [JarekGearboxEbayBulkPriceController::class, 'applyRunnerAction'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-bulk-price-increase-apply-runner.action');
    Route::post('/admin/tools/jarek-gearboxes/ebay-bulk-price-increase-apply-runner-resume', [JarekGearboxEbayBulkPriceController::class, 'applyRunnerResume'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-bulk-price-increase-apply-runner.resume');
    Route::get('/admin/tools/jarek-gearboxes/ebay-bulk-price-increase-apply-runner-status', [JarekGearboxEbayBulkPriceController::class, 'applyRunnerStatus'])->middleware(['admin.panel', 'throttle:tools'])->name('admin.tools.jarek-gearboxes.ebay-bulk-price-increase-apply-runner-status');
    ...
    Route::get('/admin/tools/allegro/gpsr-audit-runner', [AllegroGpsrAuditRunnerController::class, 'index'])->name('admin.tools.allegro.gpsr-audit-runner.index')->middleware(['admin.panel', 'throttle:tools']);
    Route::get('/admin/tools/allegro/gpsr-audit-runner/diagnose', [AllegroGpsrAuditRunnerController::class, 'diagnose'])->name('admin.tools.allegro.gpsr-audit-runner.diagnose')->middleware(['admin.panel', 'throttle:tools']);
    Route::get('/admin/tools/allegro/gpsr-audit-runner/status', [AllegroGpsrAuditRunnerController::class, 'status'])->name('admin.tools.allegro.gpsr-audit-runner.status')->middleware(['admin.panel', 'throttle:tools']);
    Route::get('/admin/tools/allegro/gpsr-audit-runner/export.json', [AllegroGpsrAuditRunnerController::class, 'exportJson'])->name('admin.tools.allegro.gpsr-audit-runner.export-json')->middleware(['admin.panel', 'throttle:tools']);
    Route::get('/admin/tools/allegro/gpsr-audit-runner/export.csv', [AllegroGpsrAuditRunnerController::class, 'exportCsv'])->name('admin.tools.allegro.gpsr-audit-runner.export-csv')->middleware(['admin.panel', 'throttle:tools']);
    Route::post('/admin/tools/allegro/gpsr-audit-runner/start', [AllegroGpsrAuditRunnerController::class, 'start'])->name('admin.tools.allegro.gpsr-audit-runner.start')->middleware(['admin.panel', 'throttle:tools']);
    Route::post('/admin/tools/allegro/gpsr-audit-runner/run-next-batch', [AllegroGpsrAuditRunnerController::class, 'runNextBatch'])->name('admin.tools.allegro.gpsr-audit-runner.run-next-batch')->middleware(['admin.panel', 'throttle:tools']);
    ...
    Route::get('/admin/tools/ovoko/import-car-payload-preview', OvokoImportCarPayloadPreviewController::class)->name('admin.tools.ovoko.import-car-payload-preview');
    ...
    Route::post('/admin/tools/ovoko/part-mapping-reset-runner/start-validate-smoke', [OvokoPartMappingResetRunnerController::class, 'startValidateSmoke'])->name('admin.tools.ovoko.part-mapping-reset-runner.start-validate-smoke');
    Route::post('/admin/tools/ovoko/part-mapping-reset-runner/start-query-smoke', [OvokoPartMappingResetRunnerController::class, 'startQuerySmoke'])->name('admin.tools.ovoko.part-mapping-reset-runner.start-query-smoke');
    Route::post('/admin/tools/ovoko/part-mapping-reset-runner/query-build-smoke', [OvokoPartMappingResetRunnerController::class, 'queryBuildSmoke'])->name('admin.tools.ovoko.part-mapping-reset-runner.query-build-smoke');
    Route::post('/admin/tools/ovoko/part-mapping-reset-runner/query-count-smoke', [OvokoPartMappingResetRunnerController::class, 'queryCountSmoke'])->name('admin.tools.ovoko.part-mapping-reset-runner.query-count-smoke');
    Route::post('/admin/tools/ovoko/part-mapping-reset-runner/query-first-smoke', [OvokoPartMappingResetRunnerController::class, 'queryFirstSmoke'])->name('admin.tools.ovoko.part-mapping-reset-runner.query-first-smoke');
    Route::get('/admin/tools/ovoko/part-mapping-reset-runner/schema-debug', [OvokoPartMappingResetRunnerController::class, 'schemaDebug'])->name('admin.tools.ovoko.part-mapping-reset-runner.schema-debug');
    ...
    Route::post('/admin/tools/ovoko/order-shipment-fetch-label', OvokoOrderShipmentFetchLabelController::class)->name('admin.tools.ovoko.order-shipment-fetch-label');
    Route::get('/admin/tools/ovoko/order-shipment-label-diagnose', OvokoOrderShipmentDiagnoseController::class)->name('admin.tools.ovoko.order-shipment-label-diagnose');
...
Route::middleware(Authenticate::class)->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::get('/tools/marketplace/parts/{part}/ebay-price-sync-diagnose', EbayPriceSyncDiagnoseController::class)->name('tools.marketplace.parts.ebay-price-sync-diagnose');
